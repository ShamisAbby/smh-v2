...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2023 at 09:24 AM
...
INSERT INTO `answers` (`aswID`, `userID`, `aswBdy`, `questID`, `time`) VALUES
(1, 4, 'bwana eeeh hiliswali halina jibu ', 4, '2023-06-22 03:45:49'),
(2, 4, 'Nulla animi laudantium odit saepe alias reiciendis, corporis error impedit mollitia sit, esse porro quisquam cumque, libero sequi! Architecto accusamus rerum libero?', 5, '2023-06-22 06:19:59'),
(5, 2, 'hello', 7, '2023-07-03 08:27:19'),
(6, 18, 'heello', 7, '2023-07-23 18:28:02'),
(7, 2, 'hello', 7, '2023-07-31 05:48:56'),
(8, 6, 'hello', 7, '2023-07-31 20:52:33');
...
(5, 2, 5, 'Education', 'DISN'),
(6, 3, 6, 'Introduction To Linux', 'DSS/SIT - 321');
...
(5, 2, 'Essential Mathmetics ', 'This document cover all first semester topic and exams reviews for the past five(5) years  ', 'Tsh500', 'hasnetDoc_1688019888.pdf', 1),
(6, 3, 'Simple command for linux', 'This document is about simple command for using linux and also linux file hirecle ', 'Tsh500', 'AbbyDoc_1688665560.pdf', 0);
...
(7, 8, 'Easly connect with resources you need to solve your hardest questions and gives you notes summarys and score marks on your exams', '2023-07-02 18:19:49');
...
(3, 8, 'Daud Khamis', 'BITAM/11/21/055/TZ', '0777800257', '0774251462', 'Zantel', 'BITAM', 2),
(29, 18, 'Hamad Daud', 'BAGES/21/12/011/TZ', '0524253636', '0536362536', 'Vodacom', 'BAGES', 2);
...
(9, 3, 987654321, 4, '2023-07-02 18:19:25');
...
(2, 'shamic', '8cb2237d0679ca88db6464eac60da96345513964', 'shamis@gmail.com', 3, '2023-08-01 06:10:20'),
(4, 'hasnet', '8cb2237d0679ca88db6464eac60da96345513964', 'hasnet@gmail.com', 3, '2023-08-01 02:41:43'),
(5, 'teacher3', '8cb2237d0679ca88db6464eac60da96345513964', 'teacher3@gmail.com', 2, '2023-06-29 19:55:49'),
(6, 'teacher1', '8cb2237d0679ca88db6464eac60da96345513964', 'teacher1@gmail.com', 2, '2023-07-31 20:54:27'),
(8, 'Abby', '8cb2237d0679ca88db6464eac60da96345513964', 'abby@gmail.com', 3, '2023-07-08 17:17:21'),
(18, 'daudi', '8cb2237d0679ca88db6464eac60da96345513964', 'daudi@gmail.com', 3, '2023-07-24 05:58:26');
...
--
ALTER TABLE `answers`
  MODIFY `aswID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `courses`
--
ALTER TABLE `courses`
  MODIFY `crsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `students`
  MODIFY `studID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
